...
insert into user_details(id,birth_date,name) values (10003,current_date(), 'Raja');

insert into post(id,description,user_id) values (20001,'I want to learn AWS!', 10001);
insert into post(id,description,user_id) values (20002,'I want to learn JAVA!', 10001);
insert into post(id,description,user_id) values (20003,'I want to get Azure Certified!', 10002);
